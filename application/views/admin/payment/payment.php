        ...
        <div class="row ">
            <div class="col-lg-12">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <i class="fa fa-table"></i>  Payment Status List
                        </div>
                        <div class="col-md-4 text-right">
                            <a href="<?php echo base_url('admin/Payment/import'); ?>" class="editLink btn btn-success btn-sm ">Upload Payment Status</a>
                        </div>
                    </div>
                    </div>
                    <div class="card">
                                ...
                                <tbody>
                                    ...
                                    if(isset($applicant_list)){
                                        ...
                                        foreach($applicant_list as $applicants){
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo $applicants->pay_tx_id; ?></td>
                                                <td><?php echo $applicants->amount; ?></td>
                                                <td><?php echo $applicants->date; ?></td>
                                                <td><?php echo $applicants->fee; ?></td>
                                                <td><?php echo $applicants->amount- $applicants->fee; ?></td>
