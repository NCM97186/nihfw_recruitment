                                ...
                                <td colspan="2" style="text-align: left; width: 100%;">
                                                <table  class="table table-bordered" style="width: 100%" id="tblcndt">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <th style="width: 40%;"><?php echo $user_details->application_id; ?></th>
                                                          
                                                            <th rowspan="4"><img src="<?= base_url('uploads/photograph/'.$user_details->photograph); ?>" alt="user" class="img-responsive" style="width:150px; margin: 0 auto;"></th>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td><b>Email</b></td>
                                                            <td colspan="2"><?php echo $user_details->cand_email; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>Category</b></td>
                                                            <td colspan="2"><?php echo $cat_id->category; ?></td>
                                                            <!-- <th ><img src="<?php // base_url('uploads/category/').$user_details->category_attachment; ?>" alt="user" class="img-responsive" style="width:150px; margin: 0 auto;"></th> -->
                                                        </tr>
                                                        <tr>
                                                            <td><b>Post Name</b></td>
                                                            <td colspan="2"><?php echo $user_details->post_name; ?></td>
                                                        </tr>
                                                ...
                                                <table  class="table table-bordered" style="width: 100%" id="tblcndt">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <td  ><b>Age </b></td>
                                                            <td  colspan="2"><?php echo $y . " Year, " . $w . " Weeks, and " . $d . " Days\n"; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Gender</b></td>
                                                            <td  colspan="2"><?php echo $user_details->gender; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Marital Status</b></td>
                                                            <td  colspan="2"><?php echo $user_details->marital_status; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Father's Name</b></td>
                                                            <td  colspan="2"><?php echo $user_details->father_name; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Mother's Name</b></td>
                                                            <td  colspan="2"><?php echo $user_details->mother_name; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Present postal Address</b></td>
                                                            <td  colspan="2"><?php echo $user_details->corr_address; ?></td>
                                                        </tr>    
                                                        <tr>
                                                            <td  ><b>Pincode</b></td>
                                                            <td  colspan="2"><?php echo $user_details->corr_pincode; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Permanent Address</b></td>
                                                            <td  colspan="2"><?php echo $user_details->perm_address; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Pincode</b></td>
                                                            <td  colspan="2"><?php echo $user_details->perm_pincode; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Identity Proof</b></td>
                                                            <td  ><?php echo $user_details->identity_proof; ?></td>
                                                          
                                                        </tr>
                                                        <tr>
                                                            <td  ><b>Identity Number</b></td>
                                                            <td  ><?php echo $user_details->corr_address; ?></td>
                                    ...
                                    <th align="right" style="width: 20%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?= base_url('uploads/signature/').@$user_details->signature; ?>" alt="user" class="img-responsive" style="width:100px; margin: 0 auto;">
</td>
                                        </tr>
                                        <tr>
                                            <td><b>Fee</b></td>
