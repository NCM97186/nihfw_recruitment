                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 70%;">
                                                            <input name="first_name" type="text" class="CapLetter form-control" style=" width:70%;" value="<?php echo set_value('first_name'); ?>">
                                                            <br />
                                                            <em>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 70%;">
                                                            <input name="middel_name" type="text" class="CapLetter form-control" style=" width:70%;" value="<?php echo set_value('middel_name'); ?>" >
                                                            <br />
                                                            <em>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 70%;">
                                                            <input name="last_name" type="text" class="CapLetter form-control" style=" width:70%;" value="<?php echo set_value('cand_name'); ?>">
                                                            <br />
                                                    ...
                                                    <tr>
                                                        <td align="right" style="width: 30%;">
                                                            <span id="">Security Code</span><span style="font-size: medium; color: #CC0000"><strong>*</strong></span>
                                                        </td>
                                                        <td align="left" style="width: 70%;">
                                                        <input type="text" class="form-control" style="width:20%; float:left;     margin-right: 12px;">
