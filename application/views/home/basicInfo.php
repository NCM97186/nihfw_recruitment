<div class="contact-page-area container-fluid padding-bottom">
    <div class="tabbable">
        <ul class="nav nav-tabs wizard">
            <li class="active"><a href="<?php echo base_url('basic_info')?>" data-toggle="tab" aria-expanded="false"><span class="nmbr">1</span>Basic Info</a></li>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 70%;">
                                                            <input name="image" type="text" maxlength="50" id="" title="Please upload your current Photograph" class="CapLetter form-control" style=" width:70%;" value="<?php echo set_value('image'); ?>" accept="image/x-png,image/gif,image/jpeg">
                                                            <br />
                                                            <em>
                                                    ...
                                                    <tr>
                                                        <td align="right" style="width: 30%;">
                                                            ...
                                                            <span id="">Middle Name </span><span style="font-size: medium; color: #CC0000"><strong>*</strong></span>
                                                        </td>
                                                        <td align="left" style="width: 70%;">
                                                            <input name="signature" type="text" maxlength="50" id="" title="Please upload your Signature" class="CapLetter form-control" style=" width:70%;" value="<?php echo set_value('signature'); ?>" accept="image/x-png,image/gif,image/jpeg">
                                                            <br />
                                                            <em>
                                ...
                                <tbody>
                                    <tr class="bg-info">
                                        <td colspan="2" style="text-align: center;">
                                            <input type="submit" name="" value="Save & Next" onclick="" id="" class="btn btn-success" style="font-weight:bold;width:250px;">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
