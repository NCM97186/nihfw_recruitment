...
<a href="<?php echo base_url() . "user/logout"; ?>"">Logout</a>
    ...
    &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url() . "dashboard/UserDashboard"; ?>"" style="float:left;">Dashboard</a>
</div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 70%;">
                                                            ...
                                                            <input name="first_name" onkeypress="return onlyAlphabets(event,this);" type="text"  class="CapLetter form-control" style=" width:70%;" value="<?php echo set_value("first_name", @$basic_info->first_name); ?>">
                                                            <br />
                                                            <em>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 70%;">
                                                            <input name="middel_name" type="text" onkeypress="return onlyAlphabets(event,this);" class="CapLetter form-control" style=" width:70%;" value="<?php echo set_value("middel_name", @$basic_info->middel_name); ?>">
                                                            <br />
                                                            <em>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="width: 70%;">
                                                            <input name="last_name" onkeypress="return onlyAlphabets(event,this);" type="text"  class="CapLetter form-control" style=" width:70%;" value="<?php echo set_value("last_name", @$basic_info->last_name); ?>">
                                                            <br />
