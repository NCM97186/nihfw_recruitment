...
class  Payment_model extends CI_Model {
	...
	public function get_card_lists($advertise,$postid,$gender_id,$category_id,$status_id,$fromdate, $todate,$export)
    {
		...
		,jp.post_name
		,adv.adver_no	
		,adv.adver_title,ps.pay_tx_id,ps.amount ,ps.date,fe.fee FROM
				users_detail cf
			...
			INNER JOIN payment_status ps ON  ps.application_id = cf.application_id 
			INNER JOIN fee fe ON  fe.cat_id = cf.category 
			where 1';
				if($advertise){
